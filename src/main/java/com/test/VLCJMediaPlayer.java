...
public class VLCJMediaPlayer {
    ...
    private final VLCPLayerEventAdapter adapter;
    ...
    public VLCJMediaPlayer(String media, int texture, VLCPLayerEventAdapter adapter ) {
        this.media = media;
    ...
    private final class TestMediaPlayerEventAdapter extends MediaPlayerEventAdapter {
        ...
        public void mediaMetaChanged(MediaPlayer mediaPlayer, int metaType) {
            ...
            if (!mediaPlayer.getTrackInfo(TrackType.VIDEO).isEmpty()) {
                ...
                adapter.mediaMetaChanged(new MediaMeta(info.width(), info.height(), info.frameRate()));
